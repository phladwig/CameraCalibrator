...
# # Look for the header file.
 FIND_PATH(VIDEOINPUT_INCLUDE_DIR NAMES videoInput.h HINTS ${CURRENT_DEPS_PATH}/include)

# # Look for the library path
 FIND_PATH(VIDEOINPUT_LIBRARIES_DIR NAMES videoInput.lib HINTS ${CURRENT_DEPS_PATH}/lib)

# # all listed variables are TRUE
 INCLUDE(FindPackageHandleStandardArgs)
 FIND_PACKAGE_HANDLE_STANDARD_ARGS(VideoInput DEFAULT_MSG VIDEOINPUT_INCLUDE_DIR VIDEOINPUT_LIBRARIES_DIR)
